...
# Run this script to plot images with their respective bounding boxes
...
def main():
    path_to_images_train = "multiple_city_data/images/train" 
    path_to_labels_train = "multiple_city_data/labels/train" 
    output_path = "./labeled_images_example"         
